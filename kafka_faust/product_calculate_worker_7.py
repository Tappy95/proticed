...
class ProductCalculator(BaseCalculator):
    ...
    def calculated_info(self, state, i):
        ...
        return {
            ...
            "cvr_total": round(state.sold_total_last[i] / state.visit_total_last[i] if state.visit_total_last[i] else 0, 6),
    ...
    def convert_to_result(self, i):
        ...
        info = self.calculated_info(self.product_info, i)
